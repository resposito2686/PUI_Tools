...
Change History:
    ...
    02/21/22 : vBeta3 - puibtool.exe tool intergrated.
    02/28/22 : vBeta4 - Device settings + console font selection.
    03/01/22 : vBeta5 - Function-based implimentation -> class-based implimentation + Log Parser.
    ...
    03/22/22 : vBeta9a - Futher threading improvements + error log improvements.
    --------------------------------------------------------------------------------------------------------------------
...
class SettingsWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #: Setting 62 Widget.
        sett_report_server_label = Label(self, text='Report Server Address') # setting 62
        ...
        #: Setting 63 Widget.
        sett_report_port_label = Label(self, text='Report Server Port') # setting 63
        ...
        #: Setting 65 Widget.
        sett_dman_server_label = Label(self, text='DMAN Server Address') # setting 65
        ...
        #: Setting 66 Widget.
        sett_dman_port_label = Label(self, text='DMAN Server Port') # setting 66
        ...
        #: Setting 64 Widget.
        sett_cell_init_label = Label(self, text='Cell Init String') # setting 64
        ...
        #: Setting 68 Widget.
        sett_apn_label = Label(self, text='APN') # setting 68
...
class PUIbtoolWindow(Toplevel):
    ...
    def run_puibtool(self):
        ...
        try:
            ERR_LOGGER.info(f'Running puibtool: {fw_cmd}')
            with subprocess.Popen(fw_cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, bufsize=1, 
